...
cd $SDK_ROOT
mkdir contrib
tar -C contrib -xvf opensync-3.0.X.0-sdk-bcm-5.04L.02-patches-XX.tar.gz
cp -a contrib/files/*/. .
...
```
mkdir dl
tar -C dl -xvf opensync-3.0.X.0-sdk-bcm-5.04L.02-dl-XX.tar.gz
```
...
```
tar -C $SDK_ROOT/contrib -xvf opensync-3.0.X.0-sdk-bcm-5.04L.02-patches-XX.tar.gz
```

5. Unpack archive of opensource packages to dl
```
tar -C $SDK_ROOT/dl -xvf opensync-3.0.X.0-sdk-bcm-5.04L.02-dl-XX.tar.gz
```
