...
#
mkdir -p /var/certs
cp /usr/plume/certs/awsca.pem       /var/certs/
cp /usr/plume/certs/ca.pem          /var/certs/
cp /usr/plume/certs/client.pem      /var/certs/
cp /usr/plume/certs/client_dec.key  /var/certs/
